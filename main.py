...
def run(config):
    ...
    if config.model_name=='maac':
        ...
        model = AttentionAMF.init_from_env(env,
                                           tau=config.tau,
                                           pi_lr=config.pi_lr,
                                           q_lr=config.q_lr,
                                           gamma=config.gamma,
    ...
    for ep_i in range(0, config.n_episodes, config.n_rollout_threads):
        ...
        for et_i in range(config.episode_length):
            ...
            # print(agent_actions[0].shape, agent_actions[0])  #(12, 5) one_hot
            # raise 0
            # rearrange actions to be per environment
            actions = [[ac[i] for ac in agent_actions] for i in range(config.n_rollout_threads)]  # threads *agnets_num *ac_dim
...
if __name__ == '__main__':
    ...
    parser.add_argument("env_id", help="Name of environment")   # fullobs_collect_treasure # multi_speaker_listener
